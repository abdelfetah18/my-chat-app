            ...
            <div className="w-full flex flex-col items-center flex-grow overflow-auto">
                <div className="bg-gray-50 rounded-3xl w-full flex flex-col items-center">
                    ...
                    <div className="w-full flex flex-row gap-2 items-center justify-center my-4">
                        <Link href={"/chat"} className="w-fit justify-center flex items-center px-8 py-2 rounded-lg font-medium bg-gray-200 text-gray-600 hover:bg-primaryColor hover:text-white cursor-pointer duration-300"><Icon icon='lucide:message-circle-more' className="mr-2" /> Chat</Link>
                        <Link href={"/settings"} className="w-fit justify-center flex items-center px-8 py-2 rounded-lg font-medium bg-gray-200 text-gray-600 hover:bg-primaryColor hover:text-white cursor-pointer duration-300"><Icon icon='lucide:user-pen' className="mr-2" /> Edit Profile</Link>
                    </div>
