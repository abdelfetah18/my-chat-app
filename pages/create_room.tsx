        ...
        <div className="w-11/12 flex flex-col items-center">
            <div className="lg:w-1/2 w-full flex flex-col">
                <div className="w-full flex flex-col items-center">
                    ...
                    <SubmitButton key={crypto.randomUUID()} onClick={create_room} text={"Create"} className={"bg-purple-500 text-purple-50 sm:px-16 w-11/12 flex items-center justify-center"} wrapperClassName={"w-full mt-8"} />
                </div>
            </div>
        </div>
    )
