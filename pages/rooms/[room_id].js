...
export default function Room({ rooms,user,room,room_requests }) {
  ...
  useEffect(() => {
      ...
      var ws = new WebSocket(process.env.NODE_ENV ? 'ws://my-chat-dapp.herokuapp.com/'+'/?room_id='+room._id+'&type=room&access_token='+access_token : 'ws://'+location.host.replace('3000','4000')+'/?room_id='+room._id+'&type=room&access_token='+access_token);
