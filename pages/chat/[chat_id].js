...
export default function Chat({ chats,user,chat }) {
  ...
  useEffect(() => {
      ...
      var ws = new WebSocket(process.env.NODE_ENV ? 'wss://my-chat-dapp.herokuapp.com/'+'/?room_id='+room._id+'&type=room&access_token='+access_token : 'ws://'+location.host.replace('3000','4000')+'/?type=chat&access_token='+access_token);
