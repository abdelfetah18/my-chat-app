...
export default function Chat({ chats,user }) {
  ...
  useEffect(() => {
      ...
      var ws = new WebSocket('ws://'+location.host.replace('3000','4000')+'/?type=chat&access_token='+access_token);
          ...
          <div className='md:w-5/6 w-full flex flex-col lg:w-4/6 items-center'>
            <div className='w-11/12 py-2 px-4 flex flex-row bg-[#fafbff] rounded-xl'>
              ...
              <div className='flex flex-col w-11/12 px-2'>
                ...
                <div className='font-mono text-sm text-[#acb2c8]'>{(User.bio != null ? User.bio : 'Hacker!')}</div>
              </div>
            </div>
